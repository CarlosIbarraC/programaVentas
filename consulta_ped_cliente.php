...
<?php
       ...
       try {
		...
		$statement = $conexion->prepare("SELECT c.nombre,c.vendedor,v.numero_pedido, v.referencia, v.metros,v.color,v.precio ,v.observaciones , v.fecha FROM clientes c,pedidos_ventas1 v WHERE c.id=v.id AND  c.nombre= '$id' ORDER BY `v`.`fecha` ASC ");
		$statement->execute();
   ...
   <?php
	...
	<a class="cerrar" href="cerrar.php">Cerrar Sesion </a><br><br><br>
	<a class="cerrar" href="lista_clientes.php"> volver</a>
  </center>
</body>
</html>

...
<body>
  <div class="logoc">
    ...
    <div class=" col-12 col-md-4 form-group  d-flex justify-content-center  my-auto ">      	
		    <form action="alerta_eli_ref.php" method="POST" class="formulario1 mt-2 mx-2 px-5">
      <div class="form-group">
        <center><p class="fol" ><i class="fa fa-folder-open" aria-hidden="true"></i>seleccione referencia</p></center>
    ...
    $statement1 = $conexion->prepare('SELECT referencia FROM referencias ');
    $statement1->execute();
